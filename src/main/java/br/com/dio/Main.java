...
import br.com.dio.exception.WalletlNotFoundException;
...
public class Main {
    ...
    private static void createAccount() {
        ...
        System.out.println("Informe o valor inical de  depósito");
    ...
    private static void withdraw() {
        ...
        } catch (NoFundEnoughException | AccountNotFoundException ex) {
            System.out.println(ex.getMessage());
        }
    }

    private static void deposit() {
        System.out.println("Informe a chave pix da conta para depoisto:");
        var pix = scanner.next();
    ...
    private static void incInvestment() {
        ...
        } catch (WalletlNotFoundException | AccountNotFoundException ex) {
            System.out.println(ex.getMessage());
        }
    }
